...
function videoPage(courseID){
    ...
    this.homeArrow.innerHTML = 'A';
        ...
        this.homeArrow.addEventListener('click', ()=>{
            window.location = '../layouts/courseBrowse/index.htm';
        }, false);
    ...
    this.videoInfo.innerHTML = '<div onclick="loader(\'../layouts/course/info-docs.html\')" class="barBtn">تحميل الملفات</div>\
